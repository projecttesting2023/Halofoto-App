...
import RedemptionCenterModal from "../../Helper/Modal/RedemptionCenterModal"


const Header = ({ data, onPress, navMenus, onShare }) => {
    ...
    return (
        ...
        >
            ...
            <View style={styles.buttonWrapp}>
                ...
                <RedemptionCenterModal navMenus={navMenus} onPress={onPress} onShare={onShare}/>
            </View>
        </LinearGradient>
    )
}
